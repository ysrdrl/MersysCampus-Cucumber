...
public class Parent {
    ...
    public void ddMenuParent(WebElement element,String value){
        Select ddmenu = new Select(element);
        ddmenu.selectByVisibleText(value);
        GWD.getWait().until(ExpectedConditions.textToBe(By.cssSelector("mat-form-field[formgroupname='country']"),value));
    }
